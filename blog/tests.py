...
class BlogTestCase(TestCase):
    ...
    def setUp(self):
        ...
        topic2 = Topic.objects.create(text=self.TOPIC_2_TEXT, user=user2, permission=Topic.Permissions.PRIVATE)
    ...
    def test_topic(self):
        '''testing theme creation, getting and data validation'''
    ...
    def test_entry(self):
        '''testing entry creation, getting and data validation'''
